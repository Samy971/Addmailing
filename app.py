...
# Version fonctionnelle restaurée avec améliorations CSS légères
...
st.markdown("""
    ...
    .stButton > button[kind="primary"] {
        background-color: #e97749 !important;
        border-color: #e97749 !important;
        ...
        if st.button("👁️ Générer aperçu", help="Génère un email de test pour voir le rendu"):
            with st.spinner("Génération de l'aperçu..."):
                try:
                    ...
                    # Prompt modifié pour un seul email (économie d'API)
